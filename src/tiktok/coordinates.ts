...
export interface TikTokCoordinates {
    ...
    tiktok: {
        ...
        picker: { circleX: number; columnStep: number; firstY: number; trayY: number; rowStep: number; cellX: number; cellStep: number; cellY: number; topRowY?: number; cellTopRowY?: number; visibleRows?: number };
...
export const DEVICE_COORDINATES = {
    ...
    iphoneXsMax: {
        ...
        tiktok: {
            ...
            picker: { circleX: 120, columnStep: 138, firstY: 683, trayY: 600, rowStep: 138, cellX: 69, cellStep: 138, cellY: 735, topRowY: 156, cellTopRowY: 208, visibleRows: 4 },
